    ...
    <b-colxx xxs="12">
      ...
      <div class="mb-2 mt-2">
        ...
        <b-collapse id="displayOptions" class="d-md-block">
          <span class="mr-3 d-inline-block float-md-left" v-if="!hideTypes">
            <!-- <a
          ...
          <div class="d-block d-md-inline-block pt-1">
            ...
            >
              ...
              >{{ status.label }}</b-dropdown-item>
            </b-dropdown>

          </div>
          <div class="float-md-right pt-1">
            <div class="search-sm d-inline-block float-md-right mr-1 align-top">
